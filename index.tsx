...
const MAPS_KEY = 'AIzaSyBb1LZSBgoacxsGseCsOdxegh32UUIwPeM';
...
const loadGoogleMaps = (): Promise<void> => new Promise((resolve, reject) => {
  ...
  script.src = `/proxy/maps/maps/api/js?key=${MAPS_KEY}&libraries=drawing,geometry,places&callback=__gm_cb__`;
