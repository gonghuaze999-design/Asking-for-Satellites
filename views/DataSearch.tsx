...
const DataSearch: React.FC<DataSearchProps> = ({ addTask, addLog, results, setResults, onRoiChange }) => {
  ...
  const MapComponent = (window as any).__MAP_ENGINE__ === 'google' ? GoogleMapViewComponent : AMapViewComponent;
  ...
  return (
    <div className="flex flex-1 overflow-hidden h-full">
      ...
      <main className="flex-1 relative bg-black">
        <MapComponent ref={mapRef} showDrawingTools={roiMode === 'DRAW'} onGeometryChange={setDrawGeo} />
        {loading && (
